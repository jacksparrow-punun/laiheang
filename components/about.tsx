          ...
          <motion.div
            ...
            <div className='flex flex-col items-center md:items-start'>
              ...
              <p className='text-gray-700 dark:text-gray-300 mb-6 leading-relaxed'>
                I am a dedicated financial professional with extensive
                experience in banking and accounting. My career has been built
                on a foundation of accuracy, integrity, and exceptional customer
                service.
              </p>
              <p className='text-gray-700 dark:text-gray-300 mb-6 leading-relaxed'>
                With a keen eye for detail and a passion for financial
                management, I excel in handling complex transactions,
                reconciling accounts, and providing personalized financial
                guidance to clients.
              </p>
              <p className='text-gray-700 dark:text-gray-300 leading-relaxed'>
                I am committed to continuous learning and staying updated with
                the latest financial regulations and technologies to deliver the
